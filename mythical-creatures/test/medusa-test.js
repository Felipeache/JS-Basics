...
describe('Medusa', function() {
  ...
  it('should let the first victim go free when stoning the 4th', function() {
    ...
    medusa.stare(victim3);
    console.log("===============================")
    console.log("ACABO DE CREAR EL ARRAY CON TRES VICTIMAS =>", medusa.statues)
    console.log("===============================")
    ...
    medusa.stare(victim4);
    console.log("===============================")
    console.log("Agregango la victima 4 =>", victim4)
    console.log("===============================")

    assert.equal(medusa.statues.length, 3);
    console.log("===============================")
    console.log("IMPRIMIENDO STATUS LEN =>", medusa.statues.length)
    console.log("===============================")
    assert.deepEqual(medusa.statues, [victim2, victim3, victim4]);  
    console.log("===============================")
    console.log("VERIFICANDO EL NUEVO ARRAY SIN LA VICTIMA 1 =>", medusa.statues)
    console.log("===============================")
...
describe('Person', function() {
  ...
  it('should be stoned after looking into Medusas eyes', function() {
    ...
    medusa.stare(victim);
    console.log("============================")
    console.log("STARE SPEAKING", victim)
    console.log("============================")
